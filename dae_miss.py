...
if __name__ == '__main__':
    ...
    label[prediction1>np.maximum(prediction2,prediction3)] = 1
    label[prediction2>np.maximum(prediction3,prediction1)] = 2
    label[prediction3>np.maximum(prediction2,prediction1)] = 3
